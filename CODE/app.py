...
db = mysql.connector.connect(
    host="localhost", user="root", passwd="", database="Data", charset='utf8', port=3306)
cursor = db.cursor()
...
def register():
    if request.method=='POST':
        ...
        if data == []:
            sql="insert into users (name,password,email,Gender,mobile,address,dob,Happy,Fear,Disgust,Sad,Angry,Neutral,Surprise)values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)" 
